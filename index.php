    ...
    <main class="container">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                ...
                <p>Velkommen til Ornitologforeningens webside for observationer af fugle i Danmark.
                    <br>Du er velkommen til at melde dig ind som observatør, hvis du har lyst til at bidrage til siden med dine egne observationer.</p>

                <form name="registerform" id="registerform" action="http://prfrankild.dk/sem3/ornitolog/wp-login.php?action=register" method="post" novalidate="novalidate">
                    <p>
                    ...
                    <button type="submit" name="wp-submit" id="wp-submit" class="btn btn-outline-success btn-lg btn-block">Deltag</button>
                </form>
